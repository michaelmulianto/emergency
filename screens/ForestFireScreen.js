      ...
      <EmergencyView>
        ...
        <View style={styles.card}>
          <Text style={styles.text}>
            Don't try to outrun the blaze. Instead, look for a body of water
            such as a pond or river to crouch in.
          </Text>
          <Text style={styles.text}>
            ...
            wet clothing, a blanket, or soil. Stay low and covered until the
            fire passes.
          </Text>
          <Text style={styles.text}>
          ...
          <Text style={styles.text}>
            Fill any large vessels – pools, hot tubs, garbage cans, or tubs –
